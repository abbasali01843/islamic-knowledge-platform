 ...
 *
 * The dataset is intentionally kept separate from the UI so additional surahs
 * can be added incrementally without changing QuranReaderScreen.
 */
...
private val alBaqarahAyahs = listOf(
